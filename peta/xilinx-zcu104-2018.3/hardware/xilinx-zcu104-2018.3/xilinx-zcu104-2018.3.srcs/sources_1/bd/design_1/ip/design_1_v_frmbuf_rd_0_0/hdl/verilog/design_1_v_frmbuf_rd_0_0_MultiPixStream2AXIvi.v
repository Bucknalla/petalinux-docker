...
input  [2:0] tmp_5_loc_dout;
input   tmp_5_loc_empty_n;
output   tmp_5_loc_read;
...
reg   [0:0] exitcond_reg_833_pp0_iter1_reg;
reg    tmp_5_loc_blk_n;
wire    ap_CS_fsm_state2;
reg   [10:0] j_i_i_reg_337;
reg    ap_block_state1;
...
reg   [11:0] tmp_i_i_116_reg_754;
wire   [5:0] tmp_8_fu_384_p2;
reg   [5:0] tmp_8_reg_759;
wire   [2:0] i_fu_396_p2;
reg   [2:0] i_reg_767;
wire    ap_CS_fsm_state3;
wire   [0:0] exitcond1_i_i_fu_390_p2;
wire   [10:0] tmp_8_i_i_fu_434_p4;
reg   [10:0] tmp_8_i_i_reg_784;
wire   [11:0] tmp_9_i_i_fu_447_p2;
reg   [11:0] tmp_9_i_i_reg_789;
wire   [2:0] tmp_12_fu_453_p1;
reg   [2:0] tmp_12_reg_794;
wire   [2:0] tmp_13_fu_457_p1;
reg   [2:0] tmp_13_reg_799;
wire   [2:0] tmp_14_fu_461_p1;
reg   [2:0] tmp_14_reg_804;
wire   [2:0] tmp_15_fu_465_p1;
reg   [2:0] tmp_15_reg_809;
wire   [2:0] tmp_16_fu_469_p1;
reg   [2:0] tmp_16_reg_814;
wire   [2:0] tmp_17_fu_473_p1;
reg   [2:0] tmp_17_reg_819;
wire   [0:0] exitcond2_i_i_fu_516_p2;
...
reg   [2:0] i_i_i_reg_314;
wire    ap_CS_fsm_state4;
reg   [11:0] i1_i_i_reg_326;
...
wire  signed [63:0] tmp_11_cast_fu_411_p1;
reg    StrmMPix_V_val_0_V0_update;
reg   [4:0] map_V_0_i_i_fu_210;
wire   [4:0] map_0_V_cast_fu_482_p1;
reg   [4:0] map_V_1_i_i_fu_214;
reg   [4:0] map_V_2_i_i_fu_218;
reg   [4:0] map_V_3_i_i_fu_222;
reg   [4:0] map_V_4_i_i_fu_226;
reg   [4:0] map_V_5_i_i_fu_230;
reg   [0:0] tmp_user_V_fu_234;
reg    ap_block_pp0_stage0_01001;
wire   [3:0] tmp_7_fu_372_p3;
wire   [5:0] tmp_6_fu_364_p3;
wire   [5:0] p_shl1_cast_fu_380_p1;
wire   [5:0] tmp_10_i_i_cast_fu_402_p1;
wire   [5:0] tmp_s_fu_406_p2;
wire   [11:0] tmp_9_fu_443_p1;
wire   [11:0] j_cast_i_i_fu_527_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state6) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond2_i_i_fu_516_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        i1_i_i_reg_326 <= i_1_reg_828;
    end else if (((exitcond1_i_i_fu_390_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        i1_i_i_reg_326 <= 12'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        i_i_i_reg_314 <= i_reg_767;
    end else if ((~((tmp_5_loc_empty_n == 1'b0) | (1'b1 == ap_block_state2_on_subcall_done)) & (1'b1 == ap_CS_fsm_state2))) begin
        i_i_i_reg_314 <= 3'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond2_i_i_fu_516_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        j_i_i_reg_337 <= 11'd0;
    end else if (((exitcond_fu_531_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_i_i_reg_337 <= j_fu_536_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_reg_833 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_data_V_1_load_A)) begin
        AXI_video_strm_V_data_V_1_payload_A <= cast_fu_693_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_data_V_1_load_B)) begin
        AXI_video_strm_V_data_V_1_payload_B <= cast_fu_693_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond_reg_833 <= exitcond_fu_531_p2;
        exitcond_reg_833_pp0_iter1_reg <= exitcond_reg_833;
    end
end
...
always @ (posedge ap_clk) begin
    if (((i_i_i_reg_314 == 3'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        map_V_0_i_i_fu_210[2 : 0] <= map_0_V_cast_fu_482_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((i_i_i_reg_314 == 3'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        map_V_1_i_i_fu_214[2 : 0] <= map_0_V_cast_fu_482_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((i_i_i_reg_314 == 3'd2) & (1'b1 == ap_CS_fsm_state4))) begin
        map_V_2_i_i_fu_218[2 : 0] <= map_0_V_cast_fu_482_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((i_i_i_reg_314 == 3'd3) & (1'b1 == ap_CS_fsm_state4))) begin
        map_V_3_i_i_fu_222[2 : 0] <= map_0_V_cast_fu_482_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((i_i_i_reg_314 == 3'd4) & (1'b1 == ap_CS_fsm_state4))) begin
        map_V_4_i_i_fu_226[2 : 0] <= map_0_V_cast_fu_482_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & ((i_i_i_reg_314 == 3'd5) | ((i_i_i_reg_314 == 3'd6) | (i_i_i_reg_314 == 3'd7))))) begin
        map_V_5_i_i_fu_230[2 : 0] <= map_0_V_cast_fu_482_p1[2 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond1_i_i_fu_390_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        tmp_12_reg_794 <= tmp_12_fu_453_p1;
        tmp_13_reg_799 <= tmp_13_fu_457_p1;
        tmp_14_reg_804 <= tmp_14_fu_461_p1;
        tmp_15_reg_809 <= tmp_15_fu_465_p1;
        tmp_16_reg_814 <= tmp_16_fu_469_p1;
        tmp_17_reg_819 <= tmp_17_fu_473_p1;
        tmp_8_i_i_reg_784 <= {{tmp_i_i_116_reg_754[11:1]}};
        tmp_9_i_i_reg_789 <= tmp_9_i_i_fu_447_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((tmp_5_loc_empty_n == 1'b0) | (1'b1 == ap_block_state2_on_subcall_done)) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_8_reg_759[5 : 1] <= tmp_8_fu_384_p2[5 : 1];
        tmp_i_i_116_reg_754 <= grp_reg_unsigned_short_s_fu_358_ap_return;
        tmp_i_i_reg_749 <= grp_reg_unsigned_short_s_fu_352_ap_return;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_531_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_reg_833 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((exitcond_fu_531_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((exitcond_reg_833_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_reg_833 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        tmp_5_loc_blk_n = tmp_5_loc_empty_n;
    end else begin
        tmp_5_loc_blk_n = 1'b1;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_fu_531_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond_fu_531_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_reg_833 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state8_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state7_io) | ((exitcond_reg_833 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state8_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state7_io) | ((exitcond_reg_833 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status)))));
end
...
always @ (*) begin
    ap_block_state7_io = ((exitcond_reg_833 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state7_pp0_stage0_iter1 = ((exitcond_reg_833 == 1'd0) & (1'b0 == StrmMPix_V_val_0_V0_status));
end

always @ (*) begin
    ap_block_state8_io = ((exitcond_reg_833_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign cast_fu_693_p1 = tmp_data_V_fu_677_p7;

assign exitcond1_i_i_fu_390_p2 = ((i_i_i_reg_314 == 3'd6) ? 1'b1 : 1'b0);

assign exitcond2_i_i_fu_516_p2 = ((i1_i_i_reg_326 == tmp_i_i_reg_749) ? 1'b1 : 1'b0);

assign exitcond_fu_531_p2 = ((j_i_i_reg_337 == tmp_8_i_i_reg_784) ? 1'b1 : 1'b0);
...
assign i_1_fu_521_p2 = (i1_i_i_reg_326 + 12'd1);

assign i_fu_396_p2 = (i_i_i_reg_314 + 3'd1);

assign j_cast_i_i_fu_527_p1 = j_i_i_reg_337;

assign j_fu_536_p2 = (j_i_i_reg_337 + 11'd1);
...
assign mapComp_address0 = tmp_11_cast_fu_411_p1;

assign map_0_V_cast_fu_482_p1 = mapComp_q0;

assign p_shl1_cast_fu_380_p1 = tmp_7_fu_372_p3;

assign tmp_10_i_i_cast_fu_402_p1 = i_i_i_reg_314;

assign tmp_11_cast_fu_411_p1 = $signed(tmp_s_fu_406_p2);

assign tmp_12_fu_453_p1 = map_V_0_i_i_fu_210[2:0];

assign tmp_13_fu_457_p1 = map_V_1_i_i_fu_214[2:0];

assign tmp_14_fu_461_p1 = map_V_2_i_i_fu_218[2:0];

assign tmp_15_fu_465_p1 = map_V_3_i_i_fu_222[2:0];

assign tmp_16_fu_469_p1 = map_V_4_i_i_fu_226[2:0];

assign tmp_17_fu_473_p1 = map_V_5_i_i_fu_230[2:0];

assign tmp_6_fu_364_p3 = {{tmp_5_loc_dout}, {3'd0}};

assign tmp_7_fu_372_p3 = {{tmp_5_loc_dout}, {1'd0}};

assign tmp_8_fu_384_p2 = (tmp_6_fu_364_p3 - p_shl1_cast_fu_380_p1);

assign tmp_8_i_i_fu_434_p4 = {{tmp_i_i_116_reg_754[11:1]}};

assign tmp_9_fu_443_p1 = tmp_8_i_i_fu_434_p4;

assign tmp_9_i_i_fu_447_p2 = ($signed(12'd4095) + $signed(tmp_9_fu_443_p1));
...
assign tmp_last_V_fu_542_p2 = ((j_cast_i_i_fu_527_p1 == tmp_9_i_i_reg_789) ? 1'b1 : 1'b0);

assign tmp_s_fu_406_p2 = (tmp_8_reg_759 + tmp_10_i_i_cast_fu_402_p1);

always @ (posedge ap_clk) begin
    tmp_8_reg_759[0] <= 1'b0;
    map_V_0_i_i_fu_210[4:3] <= 2'b00;
    map_V_1_i_i_fu_214[4:3] <= 2'b00;
    map_V_2_i_i_fu_218[4:3] <= 2'b00;
    map_V_3_i_i_fu_222[4:3] <= 2'b00;
    map_V_4_i_i_fu_226[4:3] <= 2'b00;
    map_V_5_i_i_fu_230[4:3] <= 2'b00;
end
