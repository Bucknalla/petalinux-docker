...
//--------------------------------------------------------------------------------
//Command: generate_target bd_722c.bd
//Design : bd_722c
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_722c,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_722c,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "ddr4_0_microblaze_mcs.hwdef" *) 
module bd_722c
   (Clk,
    IO_addr_strobe,
    IO_address,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_722c lmb_bram_I bd_722c second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_722c_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_722c_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_722c_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_722c_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_722c dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_722c_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_722c_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_722c_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_722c_second_lmb_bram_I_0 second_lmb_bram_I
