...
wire   [0:0] exitcond_i_fu_522_p2;
wire   [0:0] brmerge_i_i_i_fu_536_p2;
wire    ap_CS_fsm_state9;
wire   [0:0] ap_phi_mux_eol_2_i_i_i_phi_fu_452_p4;
reg    img_V_val_0_V_blk_n;
reg    ap_enable_reg_pp1_iter1;
reg   [0:0] exitcond_i_reg_755;
...
reg   [0:0] eol_i_i_i_reg_377;
reg   [10:0] j_i_i_i_reg_389;
...
reg   [11:0] tmp_i_i_i_189_reg_694;
reg   [63:0] tmp_data_V_cast_i_reg_699;
reg   [0:0] tmp_last_V_reg_707;
wire   [59:0] tmp_fu_484_p1;
wire    ap_CS_fsm_state4;
reg   [10:0] tmp_i_reg_724;
wire   [0:0] sel_tmp_i_fu_496_p2;
reg   [0:0] sel_tmp_i_reg_729;
wire   [0:0] sel_tmp2_i_fu_501_p2;
reg   [0:0] sel_tmp2_i_reg_736;
wire   [0:0] exitcond_i_i_i_fu_511_p2;
...
wire   [9:0] sel_tmp1_i_fu_601_p3;
wire   [9:0] pix_val_4_V_16_fu_581_p4;
wire   [9:0] sel_tmp3_i_fu_615_p3;
wire   [9:0] pix_val_0_V_fu_547_p4;
wire   [9:0] sel_tmp4_i_fu_629_p3;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond_i_i_i_fu_511_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state6) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond_i_i_i_fu_511_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        axi_data_V1_i_i_i_reg_334 <= axi_data_V_3_i_i_i_reg_437;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        axi_data_V1_i_i_i_reg_334 <= tmp_fu_484_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_i_reg_755 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        axi_data_V_1_i_i_i_reg_366 <= p_Val2_s_reg_413;
    end else if (((exitcond_i_i_i_fu_511_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        axi_data_V_1_i_i_i_reg_366 <= axi_data_V1_i_i_i_reg_334;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        axi_last_V1_i_i_i_reg_324 <= axi_last_V_3_i_i_i_reg_425;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        axi_last_V1_i_i_i_reg_324 <= tmp_last_V_reg_707;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_631)) begin
        if (((brmerge_i_i_i_fu_536_p2 == 1'd1) & (exitcond_i_fu_522_p2 == 1'd0))) begin
            axi_last_V_2_i_i_i_reg_400 <= ap_phi_mux_eol_phi_fu_358_p4;
        end else if (((brmerge_i_i_i_fu_536_p2 == 1'd0) & (exitcond_i_fu_522_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        eol_2_i_i_i_reg_449 <= eol_i_i_i_reg_377;
    end else if ((~((eol_2_i_i_i_reg_449 == 1'd0) & (s_axis_video_V_data_V_0_vld_out == 1'b0)) & (eol_2_i_i_i_reg_449 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_i_reg_755 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        eol_i_i_i_reg_377 <= axi_last_V_2_i_i_i_reg_400;
    end else if (((exitcond_i_i_i_fu_511_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        eol_i_i_i_reg_377 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_i_reg_755 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        eol_reg_355 <= axi_last_V1_i_i_i_reg_324;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state10)) begin
        i_i_i_i_reg_344 <= i_reg_750;
    end else if ((1'b1 == ap_CS_fsm_state4)) begin
        i_i_i_i_reg_344 <= 12'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_i_fu_522_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        j_i_i_i_reg_389 <= j_fu_527_p2;
    end else if (((exitcond_i_i_i_fu_511_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        j_i_i_i_reg_389 <= 11'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        exitcond_i_reg_755 <= exitcond_i_fu_522_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        sel_tmp2_i_reg_736 <= sel_tmp2_i_fu_501_p2;
        sel_tmp_i_reg_729 <= sel_tmp_i_fu_496_p2;
        tmp_i_reg_724 <= {{tmp_i_i_i_189_reg_694[11:1]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_i_i_i_189_reg_694 <= grp_reg_unsigned_short_s_fu_474_ap_return;
        tmp_i_i_i_reg_689 <= grp_reg_unsigned_short_s_fu_468_ap_return;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_i_fu_522_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((exitcond_i_fu_522_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_i_i_i_fu_511_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((exitcond_i_reg_755 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_755 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_eol_i_i_i_phi_fu_381_p4 = axi_last_V_2_i_i_i_reg_400;
    end else begin
        ap_phi_mux_eol_i_i_i_phi_fu_381_p4 = eol_i_i_i_reg_377;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_731)) begin
        if ((brmerge_i_i_i_fu_536_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_417_p4 = ap_phi_mux_axi_data_V_1_i_i_i_phi_fu_369_p4;
        end else if ((brmerge_i_i_i_fu_536_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((eol_2_i_i_i_reg_449 == 1'd0) & (1'b1 == ap_CS_fsm_state9)) | ((brmerge_i_i_i_fu_536_p2 == 1'd0) & (exitcond_i_fu_522_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond_i_fu_522_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (exitcond_i_fu_522_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((exitcond_i_reg_755 == 1'd0) & (img_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op78_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((exitcond_i_reg_755 == 1'd0) & (img_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op78_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((exitcond_i_reg_755 == 1'd0) & (img_V_val_0_V1_status == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)) | ((s_axis_video_V_data_V_0_vld_out == 1'b0) & (ap_predicate_op78_read_state6 == 1'b1) & (ap_enable_reg_pp1_iter0 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state7_pp1_stage0_iter1 = ((exitcond_i_reg_755 == 1'd0) & (img_V_val_0_V1_status == 1'b0));
end
...
always @ (*) begin
    ap_condition_631 = ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end

always @ (*) begin
    ap_condition_731 = ((exitcond_i_fu_522_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
always @ (*) begin
    ap_predicate_op78_read_state6 = ((brmerge_i_i_i_fu_536_p2 == 1'd0) & (exitcond_i_fu_522_p2 == 1'd0));
end

assign brmerge_i_i_i_fu_536_p2 = (sof_1_i_i_i_fu_246 | ap_phi_mux_eol_i_i_i_phi_fu_381_p4);

assign exitcond_i_fu_522_p2 = ((j_i_i_i_reg_389 == tmp_i_reg_724) ? 1'b1 : 1'b0);

assign exitcond_i_i_i_fu_511_p2 = ((i_i_i_i_reg_344 == tmp_i_i_i_reg_689) ? 1'b1 : 1'b0);
...
assign i_fu_516_p2 = (i_i_i_i_reg_344 + 12'd1);
...
assign j_fu_527_p2 = (j_i_i_i_reg_389 + 11'd1);
...
assign sel_tmp1_i_fu_601_p3 = ((sel_tmp_i_reg_729[0:0] === 1'b1) ? pix_val_3_V_fu_571_p4 : pix_val_5_V_fu_591_p4);

assign sel_tmp2_i_fu_501_p2 = ((tmp_3_loc_channel == 3'd0) ? 1'b1 : 1'b0);

assign sel_tmp3_i_fu_615_p3 = ((sel_tmp_i_reg_729[0:0] === 1'b1) ? pix_val_5_V_fu_591_p4 : pix_val_4_V_16_fu_581_p4);

assign sel_tmp4_i_fu_629_p3 = ((sel_tmp_i_reg_729[0:0] === 1'b1) ? pix_val_4_V_16_fu_581_p4 : pix_val_0_V_fu_547_p4);

assign sel_tmp_i_fu_496_p2 = ((tmp_3_loc_channel == 3'd1) ? 1'b1 : 1'b0);
...
assign tmp_fu_484_p1 = tmp_data_V_cast_i_reg_699[59:0];

assign tmp_user_V_fu_480_p1 = s_axis_video_V_user_V_0_data_out;

assign tmp_val_0_V_fu_657_p3 = ((sel_tmp2_i_reg_736[0:0] === 1'b1) ? pix_val_0_V_fu_547_p4 : pix_val_1_V_16_fu_557_p1);

assign tmp_val_1_V_fu_650_p3 = ((sel_tmp2_i_reg_736[0:0] === 1'b1) ? pix_val_1_V_16_fu_557_p1 : pix_val_2_V_fu_561_p4);

assign tmp_val_2_V_fu_643_p3 = ((sel_tmp2_i_reg_736[0:0] === 1'b1) ? pix_val_2_V_fu_561_p4 : pix_val_0_V_fu_547_p4);

assign tmp_val_3_V_fu_636_p3 = ((sel_tmp2_i_reg_736[0:0] === 1'b1) ? pix_val_3_V_fu_571_p4 : sel_tmp4_i_fu_629_p3);

assign tmp_val_4_V_fu_622_p3 = ((sel_tmp2_i_reg_736[0:0] === 1'b1) ? pix_val_4_V_16_fu_581_p4 : sel_tmp3_i_fu_615_p3);

assign tmp_val_5_V_fu_608_p3 = ((sel_tmp2_i_reg_736[0:0] === 1'b1) ? pix_val_5_V_fu_591_p4 : sel_tmp1_i_fu_601_p3);
